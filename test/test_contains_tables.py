...
def test_it_finds_no_tables_in_a_pdf_with_no_tables():
    fh = open('fixtures/sample_data/sample_data/m27-dexpeg2-polymer.pdf', 'rb')
    assert_equals(
...
def test_it_finds_tables_on_all_pages_AlmondBoard():
    fh = open('fixtures/sample_data/sample_data/2012.01.PosRpt.pdf', 'rb')
    assert_equals(
...
def test_it_finds_tables_on_some_pages_CONAB():
    fh = open('fixtures/sample_data/sample_data/13_06_12_10_36_58_boletim_ingles_junho_2013.pdf', 'rb')
    TestList = [False]*32
    TestList[5:8] = [True]*3
